              ...
              <div class="card">
                <div class="card-name">
                  <div class="columns is-centered">
                      ...
                      <div class="column">
                        <my-auto-complete
                        :arrInputs="local.ordering.yearSelection.inputs"
                        @select="obj => yearSelected('ordering', obj)"
                      ...
                      <div class="column">
                        <my-auto-complete
                        :arrInputs="local.ordering.monthSelection.inputs"
                        @select="obj => monthSelected('ordering', obj)"
                        :config="{getNullVal: true}"
                      ...
                      <div class="column is-2">
                        <button :class="['button is-fullwidth', {'is-loading': local.ordering.isLoading}]" @click="searchOrderingData()">ค้นหา</button>
                      </div>
                    </div>
                </div>
                <div class="card-content">
                  <template v-if="local.detailObj.ordering.length">
...
export default {
  ...
  methods: {
    ...
    yearSelected (type, obj) {
      this.local[type].yearSelection.selected = obj.key
    },
    monthSelected (type, obj) {
      this.local[type].monthSelection.selected = obj.key
    },
    searchOrderingData () {
