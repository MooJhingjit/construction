      ...
      <template slot="detail">
        <div class="container-block  detail-block">
          <div class="form-detail">
            ...
            <div class="container-block">
              <div class="text-title">หมวดงาน</div>
              <div class="value">
                 <my-input
                  :value="local.inputs.name"
                  :inputObj="{type: 'text', name: 'user_name', placeholder: 'ชื่อหมวดงาน', validate: 'required'}"
                  :validator="$validator"
        ...
        <div class="container-block footer-panel">
          <my-action
            type="link"
            :obj="{title: 'รายการ'}"
            @clickEvent="GOTOPAGE('WorkGroupDetails', local.idSelected)"
          >
...
export default {
      ...
      local: {
        pageObj: {
          items: [
            ...
            {name: 'หมวดงาน', route: 'WorkGroup', key: '', active: true, icon: ''}
          ],
          template: {
            class: 'workgroup-page'
          }
        },
  ...
  computed: {
    resourceName () {
      return config.api.workGroup.index
    }
  },
  created () {
  },
